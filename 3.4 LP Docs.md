...
⚠️ Note: Avoid adding extra elements to these components. Use only the elements included in the boilerplate to maintain the intended layout. However, you may safely remove any element you don’t need.
